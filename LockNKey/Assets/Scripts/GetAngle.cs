...
{
    public static float Angle(Vector3 SourcePos, Vector3 TargetPos)
    {
        float angle;
        float angleOpt;
        ...
        Vector3 toOther = (sourcePos - targetPos).normalized;
    ...
    static float atan2Approximation(float y, float x) // http://http.developer.nvidia.com/Cg/atan2.html
    {
